  ...
  echo '
    <div class="mt-32">
      <footer class="footer p-10 bg-base-200 text-base-content">
        <nav>
          <header class="footer-title">'.$translate["services"][$lng].'</header>
          <a class="link link-hover">Branding</a>
          <a class="link link-hover">'.$translate["design"][$lng].'</a>
          <a class="link link-hover">'.$translate["marketing"][$lng].'</a>
          <a class="link link-hover">'.$translate["advertisement"][$lng].'</a>
        </nav>
        <nav>
          <header class="footer-title">'.$translate["business"][$lng].'</header>
          <a class="link link-hover">'.$translate["about us"][$lng].'</a>
          <a class="link link-hover">Contact</a>
          <a class="link link-hover">'.$translate["vacancies"][$lng].'</a>
          <a class="link link-hover">'.$translate["press kit"][$lng].'</a>
        </nav>
        <nav>
          <header class="footer-title">'.$translate["legal"][$lng].'</header>
          <a class="link link-hover">'.$translate["terms of use"][$lng].'</a>
          <a class="link link-hover">'.$translate["privacy policy"][$lng].'</a>
          <a class="link link-hover">'.$translate["cookie policy"][$lng].'</a>
        </nav>
      </footer>
      <footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        <aside class="items-center grid-flow-col">
          ...
          <p>'.$translate["2nd-chance auctions"][$lng].'. <br/>'.$translate["reliable tech"][$lng].'</p>
        </aside>
