    ...
    <div class="mt-32">
      <footer class="footer p-10 bg-base-200 text-base-content">
        <nav>
          ...
          <a class="link link-hover">'.$txt_design[$lng].'</a>
          <a class="link link-hover">'.$txt_marketing[$lng].'</a>
          <a class="link link-hover">'.$txt_advertisement[$lng].'</a>
        </nav>
        <nav>
          <header class="footer-title">'.$txt_business[$lng].'</header>
          <a class="link link-hover">'.$txt_about_us[$lng].'</a>
          <a class="link link-hover">Contact</a>
          <a class="link link-hover">'.$txt_vacancies[$lng].'</a>
          <a class="link link-hover">'.$txt_press_kit[$lng].'</a>
        </nav>
        <nav>
          <header class="footer-title">'.$txt_legal[$lng].'</header>
          <a class="link link-hover">'.$txt_terms_of_use[$lng].'</a>
          <a class="link link-hover">'.$txt_privacy_policy[$lng].'</a>
          <a class="link link-hover">'.$txt_cookie_policy[$lng].'</a>
        </nav>
      </footer>
      <footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        <aside class="items-center grid-flow-col">
          ...
          <p>'.$txt_title[$lng].'. <br/>'.$txt_reliable_tech[$lng].'</p>
        </aside>
