...
$favorites = fetchSingle($query, ['type' => 'i', 'value' => $_SESSION['user']['id']]);
	...
	echo '
      ...
      <div class="card-body">
        ...
        <div class="card-actions justify-between items-center">
        	<p class="text-xl text-left font-bold">€' . $favorite["price"] . '</p>
          <div class="flex flex-row gap-2">
          	<a href="/catalog/product?id=' . $favorite['id'] . '" class="btn btn-primary">View product page</a>
