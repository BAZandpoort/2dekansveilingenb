    ...
    <div>
      <form action="/src/lib/user/register.php" method="post" class="flex flex-col items-center gap-4">
        <div class="flex flex-col gap-2 w-full max-w-xs">
          <label for="email">'.$translate["email"][$lng].'</label>
          <input
          name="email"
          id="email"
          type="email"
        ...
        <div class="flex flex-col gap-2 w-full max-w-xs">
          <label for="username">'.$translate["username"][$lng].'</label>
          <input
          name="username"
          id="username"
          type="text"
        ...
        <div class="flex flex-col gap-2 w-full max-w-xs">
          <label for="password">'.$translate["password"][$lng].'</label>
          <input
          name="password"
          id="password"
          type="password"
        ...
        <div class="flex flex-col gap-2 w-full max-w-xs">
          <label for="passwordConfirm">'.$translate["confirm password"][$lng].'</label>
          <input
        ...
        <input type="submit" name="register" value="'.$translate["register"][$lng].'" class="btn btn-wide place-self-center">
      </form>
